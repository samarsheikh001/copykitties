    ...
    <div className="bg-white">
          ...
          <div className="py-24 lg:py-32">
            <div className="relative z-10 mx-auto max-w-7xl pl-4 pr-8 sm:px-6 lg:px-8">
              ...
              <p className="text-warm-gray-500 mt-6 max-w-3xl text-xl">
                If you need help or have any questions, our support team is here
                to assist you.
              </p>
            </div>
          </div>
            ...
            <div className="relative bg-white shadow-xl">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3">
                  ...
                  <dl className="mt-8 space-y-6">
                    ...
                    <dd className="flex text-base text-teal-50">
                      <PhoneIcon
                        ...
                        aria-hidden="true"
                      />
                      <span className="ml-3">+91 8888698886</span>
                    </dd>
                    <dt>
                    ...
                    <dd className="flex text-base text-teal-50">
                      <MailIcon
                        ...
                        aria-hidden="true"
                      />
                      <span className="ml-3">samarsheikh001@gmail.com</span>
                    </dd>
                  </dl>
                ...
                <div className="py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12">
                  ...
                  <form
                    action="mailto:samarsheikh001@gmail.com"
                    method="POST"
      ...
      <footer className="bg-warm-gray-900" aria-labelledby="footer-heading">
        ...
        <div className="mx-auto max-w-7xl py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
          <div className="xl:grid xl:grid-cols-3 xl:gap-8">
            ...
            <div className="mt-12 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
              {/* <div className="md:grid md:grid-cols-2 md:gap-8">
                <div>
                  <h3 className="text-warm-gray-200 text-sm font-semibold uppercase tracking-wider">
                    Solutions
                  </h3>
                  <ul role="list" className="mt-4 space-y-4">
                    {footerNavigation.solutions.map((item) => (
                      <li key={item.name}>
                        <a
                          href={item.href}
                          className="text-warm-gray-400 hover:text-warm-gray-300 text-base"
                        >
                          {item.name}
                        </a>
                      </li>
          ...
          <div className="border-warm-gray-700 mt-12 border-t pt-8">
            <p className="text-warm-gray-400 text-base xl:text-center">
              &copy; 2022 Copykitties, Inc. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
