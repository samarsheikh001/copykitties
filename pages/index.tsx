              ...
              <div className="mt-20">
                ...
                <div className="mt-6 sm:max-w-xl">
                  ...
                  <p className="mt-6 text-xl text-gray-500">
                    ...
                    content in minutes, without any prior experience or
                    knowledge.
                  </p>
                </div>
            ...
            <div className="relative mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-0">
              ...
              <div className="pt-12 sm:pt-16 lg:pt-20">
                ...
                <div className="mt-6 text-gray-500 space-y-6">
                  <p className="text-lg">
                    Looking for a writing tool that can help you with your blog
                    articles, facebook ads, profile bio, quora answers, and
                    video titles? Look no further than AI Writing Tool! This
                    helpful tool uses artificial intelligence to help you write
                    better, more engaging content. Simply type in what you want
                    to write about, and AI Writing Tool will provide you with
                    content and list of suggested topics, keywords, and phrases
                    to use.
                  </p>
                  <p className="text-base leading-7">
                    It also offers real-time feedback and suggestions to help
                    improve your writing. So whether you{"'"}re a seasoned
                    writer or just starting out, AI Writing Tool is the perfect
                    tool to help you create high-quality content.
                  </p>
                </div>
              </div>
              ...
              <div className="relative">
                <div className="sm:text-center">
                  ...
                  <p className="mt-6 mx-auto max-w-2xl text-lg text-gray-100">
                    We adding templates to our platform every day. Subscribe to
                    our newsletter to get notified with new templates.
                  </p>
                </div>
                <form
                  action="#"
