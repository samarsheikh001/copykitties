                ...
                <div className="pt-12 sm:pt-16 lg:pt-20">
                  ...
                  <div className="mt-6 space-y-6 text-gray-500">
                    <p className="text-lg">
                      ...
                      and video titles? Look no further than AI Writing Tool!
                      This helpful tool uses artificial intelligence to help you
                      write better, more engaging content. Simply type in what
                      you want to write about, and AI Writing Tool will provide
                      you with content and list of suggested topics, keywords,
                      and phrases to use.
                    </p>
                    <p className="text-base leading-7">
                      It also offers real-time feedback and suggestions to help
                      improve your writing. So whether you{"'"}re a seasoned
                      writer or just starting out, AI Writing Tool is the
                      perfect tool to help you create high-quality content.
                    </p>
                  </div>
                </div>
